     ...
     function validecho1() { // validate commands
          ...
          if(e1entry == 'help'){
             setcp('help')
area1 = area1 + ' <br/> ' + 'GlowBear Help <br> Commands: <br> write {insert string message here} (Prints the message to the console) <br> repo (Takes you to the GitHub repository) <br> process (Writes the currently running process)';
document.getElementById('echo1').innerHTML = area1;
          }else{
